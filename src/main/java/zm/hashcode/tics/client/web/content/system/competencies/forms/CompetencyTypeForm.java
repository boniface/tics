...
public class CompetencyTypeForm extends FormLayout {
    ...
    private final CompetencyTypeBean bean;
    public final BeanItem<CompetencyTypeBean> item;
...
//    private String name;
        ...
        TextField name = getTextField("Competency Type Name", "name");
    ...
    private TextField getTextField(String label, String field) {
        ...
        textField.addValidator(new BeanValidator(CompetencyTypeBean.class, field));
