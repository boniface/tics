...
public class ContactListForm extends FormLayout {
    ...
    private final ContactListBean bean;
    public final BeanItem<ContactListBean> item;
    ...
    public ContactListForm() {
        ...
        TextField name = getTextField("Contact List Name", "name");
    ...
    private TextField getTextField(String label, String field) {
        ...
        textField.addValidator(new BeanValidator(ContactListBean.class, field));
