...
public class LanguageProficiencyForm extends FormLayout {
    ...
    private final LanguageProficiencyBean bean;
    public final BeanItem<LanguageProficiencyBean> item;
    ...
    public LanguageProficiencyForm() {
        bean = new LanguageProficiencyBean();
...
//    private String proficiency;
        TextField proficiency = getTextField("Proficiency", "proficiency");
...
//        ComboBox gender = getComboBox("Gender", "gender");
        ...
        grid.addComponent(proficiency, 0, 0);
    ...
    private TextField getTextField(String label, String field) {
        ...
        textField.addValidator(new BeanValidator(LanguageProficiencyBean.class, field));
