 ...
 * @author geek
 */
public class GenderForm extends FormLayout {

    private final GenderBean bean;
    public final BeanItem<GenderBean> item;
    ...
    public GenderForm() {
        ...
        TextField gender = getTextField("Gender", "gender");
...
//        ComboBox gender = getComboBox("Gender", "gender");
    ...
    private TextField getTextField(String label, String field) {
        ...
        textField.addValidator(new BeanValidator(GenderBean.class, field));
