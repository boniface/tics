 ...
 * @author geek
 */
public class TitleForm extends FormLayout {

    private final TitleBean bean;
    public final BeanItem<TitleBean> item;
...
//        ComboBox gender = getComboBox("Gender", "gender");
    ...
    private TextField getTextField(String label, String field) {
        ...
        textField.addValidator(new BeanValidator(TitleBean.class, field));
