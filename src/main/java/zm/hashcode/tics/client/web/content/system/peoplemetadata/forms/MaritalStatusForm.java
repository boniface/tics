 ...
 * @author geek
 */
public class MaritalStatusForm extends FormLayout {

    private final MaritalStatusBean bean;
    public final BeanItem<MaritalStatusBean> item;
...
//        ComboBox gender = getComboBox("Gender", "gender");
        ...
        grid.addComponent(statusName, 0, 0);
    ...
    private TextField getTextField(String label, String field) {
        ...
        textField.addValidator(new BeanValidator(MaritalStatusBean.class, field));
