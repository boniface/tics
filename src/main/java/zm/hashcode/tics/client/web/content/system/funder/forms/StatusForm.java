...
//    private String statusValue;
        ...
        TextField statusType = getTextField("Status Type", "statusType");
        TextField statusValue = getTextField("Status Value", "statusValue");

        GridLayout grid = new GridLayout(4, 10);
        grid.setSizeFull();

        grid.addComponent(statusType, 0, 0);
        grid.addComponent(statusValue, 1, 0);
    ...
    private TextField getTextField(String label, String field) {
        ...
        textField.addValidator(new BeanValidator(StatusBean.class, field));
